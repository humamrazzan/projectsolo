<x-app-layout>
    <div class="space-y-6">
        <!-- Header -->
        <div>
            <h3 class="text-3xl font-bold text-gray-800 dark:text-white">Tambah Penyewa Baru</h3>
            <div class="text-sm text-gray-500 dark:text-gray-400">Home / Penyewa / Tambah</div>
        </div>
            ...
            <form action="{{ route('penyewa.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <x-text-input id="nama_panggilan" name="nama_panggilan" type="text" class="mt-1 block w-full" :value="old('nama_panggilan')" required />
                    </div>
                    <div>
